...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-gray-100 max-w-[42rem] overflow-hidden border border-black/5 sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 rounded-lg dark:bg-white/10 dark:hover:bg-white/20 dark:text-white">
